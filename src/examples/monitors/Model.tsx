...
import { Box } from "../fishCamera/Scene";
...
export function Instances({ children, ...props }) {
  const { nodes } = useGLTF("/monitors/computers_1-transformed.glb");
...
export function Computers(props) {
  const { nodes: n, materials: m } = useGLTF(
    "/monitors/computers_1-transformed.glb"
  );
...
function Screen({ frame, panel, children, ...props }) {
  const { nodes, materials } = useGLTF("/monitors/computers_1-transformed.glb");
  return (
    <group {...props}>
      <mesh
        castShadow
...
function SpinningBox({ scale, ...props }) {
